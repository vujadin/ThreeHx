...
import com.gamestudiohx.three.renderers.shaders.ShaderLib.ShaderLibDesc;
import com.gamestudiohx.three.renderers.shaders.UniformsLib;
...
typedef ShaderLibDesc = {
	uniforms: Map<String, ULTypeValue>,
	vertexShader: String,
...
class ShaderLib {
	...
	public static var basic:ShaderLibDesc = {
	...
	public static var lambert:ShaderLibDesc = {
	...
	public static var phong:ShaderLibDesc = {
	...
	public static var particle_basic:ShaderLibDesc = {
	...
	public static var dashed:ShaderLibDesc = {
	...
	public static var depth:ShaderLibDesc = {
	...
	public static var normal:ShaderLibDesc = {
	...
	public static var normalmap:ShaderLibDesc = {
		...
		uniforms: UniformsUtils.merge( [
			...
			"uDiffuseColor"		 => { type: "c", value: new Color( 0xffffff ) },
			"uSpecularColor"	 => { type: "c", value: new Color( 0x111111 ) },
			"uAmbientColor"		 => { type: "c", value: new Color( 0xffffff ) },
	...
	public static var cube:ShaderLibDesc = {
	...
	public static var depthRGBA:ShaderLibDesc = {
